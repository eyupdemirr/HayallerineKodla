...
hangiDilAI_bp = Blueprint('hangiDilAI', __name__, template_folder='templates')
...
@hangiDilAI_bp.route('/recommendLang')
def recommend():
    return render_template('recommendLang.html')

@hangiDilAI_bp.route('/pred', methods=['POST'])
def pred():
